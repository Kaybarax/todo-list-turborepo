...
export class ApiClientFactory {
     ...
     */
    addGlobalRequestInterceptor(interceptor) {
        this.clients.forEach(client => {
     ...
     */
    addGlobalResponseInterceptor(interceptor) {
        this.clients.forEach(client => {
     ...
     */
    addGlobalErrorInterceptor(interceptor) {
        this.clients.forEach(client => {
     ...
     */
    static createForEnvironment(environment, baseUrl, overrides) {
        const config = {
            baseUrl,
            environment,
     ...
     * @param overrides - Additional configuration overrides
     */
    static createForDevelopment(port = 3001, overrides) {
