 ...
 */
export const NETWORK_DISPLAY_INFO = {
 ...
 */
export function getNetworkDisplayInfo(network) {
 ...
 */
export function getMainnetNetworkDisplayInfo() {
    return Object.values(NETWORK_DISPLAY_INFO).filter(info => !info.isTestnet);
}
/**
 * Get all testnet networks
 */
export function getTestnetNetworkDisplayInfo() {
    return Object.values(NETWORK_DISPLAY_INFO).filter(info => info.isTestnet);
}
/**
 * Get all EVM networks
 */
export function getEVMNetworkDisplayInfo() {
 ...
 */
export function getSupportedWalletNetworks() {
    return ['solana', 'polkadot', 'polygon', 'moonbeam', 'base'];
}
/**
 * Map wallet network name to BlockchainNetwork enum
 */
export function mapWalletNetworkToBlockchainNetwork(walletNetwork) {
    const mapping = {
        'solana': BlockchainNetwork.SOLANA,
        'polkadot': BlockchainNetwork.POLKADOT,
        'polygon': BlockchainNetwork.POLYGON,
 ...
 */
export function mapBlockchainNetworkToWalletNetwork(blockchainNetwork) {
    const mapping = {
    ...
    return mapping[blockchainNetwork];
}
/**
 * Get wallet connection URLs for different networks
 */
export function getWalletConnectionUrls() {
    return {
 ...
 */
export function generateMockAddress(network) {
    const prefixes = {
        solana: '1A1z',
        polkadot: '5G',
        polygon: '0x',
