...
export declare class TransactionMonitor {
     ...
     */
    monitorTransaction(txHash: string, network: BlockchainNetwork, getStatusFn: (hash: string) => Promise<TransactionReceipt | null>, options?: TransactionMonitorOptions): Promise<TransactionReceipt>;
    /**
