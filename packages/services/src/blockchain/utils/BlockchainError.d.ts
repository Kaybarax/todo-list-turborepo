...
export declare class BlockchainError extends Error {
     ...
     */
    constructor(type: BlockchainErrorType, message: string, options?: {
        originalError?: unknown;
        transactionHash?: string;
        network?: BlockchainNetwork;
    });
     ...
     * @param network - Blockchain network
     */
    static transactionFailed(message: string, transactionHash?: string, originalError?: unknown, network?: BlockchainNetwork): BlockchainError;
    /**
     ...
     * @param options - Additional error options
     */
    static connectionFailed(message: string, network?: BlockchainNetwork, options?: {
        originalError?: unknown;
    }): BlockchainError;
    /**
     ...
     * @param network - Blockchain network
     */
    static moonbeamConnectionFailed(message: string, originalError?: unknown, network?: BlockchainNetwork): BlockchainError;
    /**
