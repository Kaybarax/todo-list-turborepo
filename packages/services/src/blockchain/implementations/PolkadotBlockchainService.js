...
export class PolkadotBlockchainService extends BaseBlockchainService {
    ...
    async connectWallet(options) {
        try {
            ...
            if (!options?.walletExtension || !options?.account) {
                throw BlockchainError.walletNotFound('Wallet extension or account not provided for Polkadot connection', this.network);
            }
            // Connect to the API
            ...
            throw BlockchainError.connectionFailed('Failed to connect to Polkadot wallet', this.network, { originalError: error });
        }
    }
    /**
    ...
    async disconnectWallet() {
        try {
            ...
            throw BlockchainError.connectionFailed('Failed to disconnect from Polkadot wallet', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getWalletBalance(tokenAddress) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Polkadot wallet balance', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTodos() {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to fetch todos from Polkadot', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTodoById(_id) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to fetch todo from Polkadot', this.network, { originalError: error });
        }
    }
    /**
    ...
    async createTodo(_todo) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to create todo on Polkadot', this.network, { originalError: error });
        }
    }
    /**
    ...
    async updateTodo(_id, _todo) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to update todo on Polkadot', this.network, { originalError: error });
        }
    }
    /**
    ...
    async deleteTodo(_id) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to delete todo on Polkadot', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTransactionStatus(txHash) {
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Polkadot transaction status', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTransactionReceipt(txHash) {
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Polkadot transaction receipt', this.network, { originalError: error });
        }
    }
    /**
...
//# sourceMappingURL=PolkadotBlockchainService.js.map