...
export class SolanaBlockchainService extends BaseBlockchainService {
    ...
    async connectWallet(options) {
        try {
            ...
            throw BlockchainError.connectionFailed('Failed to connect to Solana wallet', this.network, { originalError: error });
        }
    }
    /**
    ...
    async disconnectWallet() {
        try {
            ...
            throw BlockchainError.connectionFailed('Failed to disconnect from Solana wallet', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getWalletBalance(tokenAddress) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Solana wallet balance', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTodos() {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to fetch todos from Solana', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTodoById(_id) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to fetch todo from Solana', this.network, { originalError: error });
        }
    }
    /**
    ...
    async createTodo(_todo) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to create todo on Solana', this.network, { originalError: error });
        }
    }
    /**
    ...
    async updateTodo(_id, _todo) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to update todo on Solana', this.network, { originalError: error });
        }
    }
    /**
    ...
    async deleteTodo(_id) {
        ...
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to delete todo on Solana', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTransactionStatus(txHash) {
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Solana transaction status', this.network, { originalError: error });
        }
    }
    /**
    ...
    async getTransactionReceipt(txHash) {
        try {
            ...
            throw BlockchainError.transactionFailed('Failed to get Solana transaction receipt', this.network, { originalError: error });
        }
    }
    /**
...
//# sourceMappingURL=SolanaBlockchainService.js.map