import { BlockchainNetwork, TransactionStatus, TransactionReceipt, BlockchainTodo, CreateBlockchainTodoInput, UpdateBlockchainTodoInput, WalletInfo } from '../types';
 ...
 */
export declare abstract class BaseBlockchainService implements BlockchainService {
    protected network: BlockchainNetwork;
    protected walletInfo: WalletInfo | null;
...
//# sourceMappingURL=BaseBlockchainService.d.ts.map