...
describe('Badge', () => {
  ...
  it('renders with correct variant classes', () => {
    ...
    variants.forEach((variant) => {
      const { unmount } = render(<Badge variant={variant} data-testid={`badge-${variant}`}>Test</Badge>);
  ...
  it('renders with correct size classes', () => {
    ...
    sizes.forEach((size) => {
      const { unmount } = render(<Badge size={size} data-testid={`badge-${size}`}>Test</Badge>);
  ...
  it('renders with correct shape classes', () => {
    ...
    shapes.forEach((shape) => {
      const { unmount } = render(<Badge shape={shape} data-testid={`badge-${shape}`}>Test</Badge>);
  ...
  it('passes through additional props', () => {
    render(<Badge data-testid="badge" aria-label="Custom badge">Test</Badge>);
    const badge = screen.getByTestId('badge');
  ...
  it('renders with dot indicator', () => {
    render(<Badge dot data-testid="badge">Dot Badge</Badge>);
  ...
  it('does not render icon when dot is true', () => {
    const icon = <span data-testid="icon">🎉</span>;
    render(<Badge dot icon={icon} data-testid="badge">Dot Badge</Badge>);
