...
describe('Badge', () => {
  ...
  it('renders with different sizes', () => {
    ...
    sizes.forEach((size) => {
      const { getByText, unmount } = render(
        <Badge text={`${size} badge`} size={size} />,
        { wrapper: TestWrapper }
      );
  ...
  it('passes through testID', () => {
    const { getByTestId } = render(
      <Badge text="Test Badge" testID="custom-badge" />,
      { wrapper: TestWrapper }
    );
  ...
  describe('UI Kitten integration', () => {
    ...
    it('applies correct text categories for different sizes', () => {
      ...
      sizes.forEach((size) => {
        const { getByText, unmount } = render(
          <Badge text={`${size} category`} size={size} />,
          { wrapper: TestWrapper }
        );
