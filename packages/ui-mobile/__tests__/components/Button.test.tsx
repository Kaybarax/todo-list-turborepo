...
describe('Button', () => {
  ...
  it('renders with left icon', () => {
    const { getByText } = render(<Button title="With Icon" leftIcon="star" onPress={() => {}} />, {
      wrapper: TestWrapper,
    });
  ...
  it('renders with right icon', () => {
    const { getByText } = render(<Button title="With Icon" rightIcon="arrow-forward" onPress={() => {}} />, {
      wrapper: TestWrapper,
    });
  ...
  it('renders with both left and right icons', () => {
    const { getByText } = render(
      <Button title="With Icons" leftIcon="star" rightIcon="arrow-forward" onPress={() => {}} />,
      { wrapper: TestWrapper },
    );
  ...
  it('applies fullWidth style', () => {
    const { getByText } = render(<Button title="Full Width" fullWidth onPress={() => {}} />, { wrapper: TestWrapper });
  ...
  it('applies rounded style', () => {
    const { getByText } = render(<Button title="Rounded" rounded onPress={() => {}} />, { wrapper: TestWrapper });
  ...
  it('applies custom style', () => {
    ...
    const { getByText } = render(<Button title="Custom Style" style={customStyle} onPress={() => {}} />, {
      wrapper: TestWrapper,
    });
  ...
  it('handles different icon colors', () => {
    const { getByText } = render(
      <Button title="Colored Icon" leftIcon="star" iconColor="#FF0000" onPress={() => {}} />,
      { wrapper: TestWrapper },
    );
  ...
  describe('Variant mapping', () => {
    ...
    it('maps danger variant correctly', () => {
      const { getByText } = render(<Button title="Danger" variant="danger" onPress={() => {}} />, {
        wrapper: TestWrapper,
      });
    ...
    it('maps success variant correctly', () => {
      const { getByText } = render(<Button title="Success" variant="success" onPress={() => {}} />, {
        wrapper: TestWrapper,
      });
  ...
  describe('Size mapping', () => {
    it('maps small size correctly', () => {
      const { getByText } = render(<Button title="Small" size="small" onPress={() => {}} />, { wrapper: TestWrapper });
    ...
    it('maps large size correctly', () => {
      const { getByText } = render(<Button title="Large" size="large" onPress={() => {}} />, { wrapper: TestWrapper });
