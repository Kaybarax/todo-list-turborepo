...
describe('Checkbox', () => {
  it('renders correctly with default props', () => {
    const { getByTestId } = render(
      <Checkbox checked={false} onValueChange={() => {}} testID="default-checkbox" />,
      { wrapper: TestWrapper }
    );
  ...
  it('renders in checked state', () => {
    const { getByTestId } = render(
      <Checkbox checked={true} onValueChange={() => {}} testID="checked-checkbox" />,
      { wrapper: TestWrapper }
    );
  ...
  it('renders in unchecked state', () => {
    const { getByTestId } = render(
      <Checkbox checked={false} onValueChange={() => {}} testID="unchecked-checkbox" />,
      { wrapper: TestWrapper }
    );
  ...
  describe('Complex checkbox scenarios', () => {
    ...
    it('handles long label text', () => {
      const longLabel = 'This is a very long label that should wrap properly in the checkbox component and maintain readability';
      const { getByText } = render(
        <Checkbox 
          checked={false} 
          onValueChange={() => {}} 
    ...
    it('does not call onValueChange when disabled', () => {
      ...
      const { getByTestId } = render(
        <Checkbox 
          ...
          onValueChange={onValueChange} 
          disabled
          testID="disabled-toggle-checkbox"
        />,
        { wrapper: TestWrapper }
      );
