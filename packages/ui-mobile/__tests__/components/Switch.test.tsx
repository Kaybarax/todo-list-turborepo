...
describe('Switch', () => {
  it('renders correctly with default props', () => {
    const { getByTestId } = render(
      <Switch value={false} onValueChange={() => {}} testID="default-switch" />,
      { wrapper: TestWrapper }
    );
  ...
  it('renders in checked state', () => {
    const { getByTestId } = render(
      <Switch value={true} onValueChange={() => {}} testID="checked-switch" />,
      { wrapper: TestWrapper }
    );
  ...
  it('renders in unchecked state', () => {
    const { getByTestId } = render(
      <Switch value={false} onValueChange={() => {}} testID="unchecked-switch" />,
      { wrapper: TestWrapper }
    );
