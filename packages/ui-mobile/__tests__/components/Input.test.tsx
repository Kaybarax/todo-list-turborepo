...
describe('Input', () => {
  it('renders correctly with default props', () => {
    const { getByDisplayValue } = render(
      <Input value="Test Input" onChangeText={() => {}} />,
      { wrapper: TestWrapper }
    );
  ...
  describe('Variant mapping', () => {
    it('maps default variant correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Default" variant="default" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps outline variant correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Outline" variant="outline" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps filled variant correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Filled" variant="filled" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
  ...
  describe('Size mapping', () => {
    it('maps small size correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Small" size="small" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps medium size correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Medium" size="medium" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps large size correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Large" size="large" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
  ...
  describe('Status mapping', () => {
    it('maps basic status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Basic" status="basic" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps primary status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Primary" status="primary" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps success status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Success" status="success" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps info status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Info" status="info" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps warning status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Warning" status="warning" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
    ...
    it('maps danger status correctly', () => {
      const { getByDisplayValue } = render(
        <Input value="Danger" status="danger" onChangeText={() => {}} />,
        { wrapper: TestWrapper }
      );
