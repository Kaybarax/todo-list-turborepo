...
usage(){ echo "Usage: packages/ui-mobile/cleanup.sh [--yes] [--dry-run] [--verbose]"; }
...
cd "$(cd "$(dirname "$0")" && pwd)"
echo "Cleaning packages/ui-mobile artifacts..."
...
if confirm "Remove node_modules in packages/ui-mobile?"; then run_cmd "rm -rf node_modules"; fi
echo "packages/ui-mobile cleanup done."
