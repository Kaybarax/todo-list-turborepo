...
describe('Switch Component', () => {
  it('renders correctly', () => {
    ...
    const { getByTestId } = render(<Switch value={false} onValueChange={onValueChange} testID="test-switch" />);
  ...
  it('disables interaction when disabled', () => {
    ...
    const { getByTestId } = render(
      <Switch value={false} onValueChange={onValueChange} disabled={true} testID="test-switch" />,
    );
