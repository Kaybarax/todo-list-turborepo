...
describe('Cross-Platform Compatibility', () => {
  ...
  describe('Platform Detection', () => {
    test('should detect current platform correctly', () => {
      ...
      const expectedPlatform = process.platform === 'darwin' ? 'macos' : 
    ...
    test('should handle unknown platforms gracefully', () => {
      ...
      const mockUname = createTestFixture('mock-uname', `#!/bin/bash
if [ "$1" = "-s" ]; then
  echo "UnknownOS"
  exit 0
fi
...
exit 0`);
  ...
  describe('Architecture Detection', () => {
    test('should detect system architecture', () => {
      ...
      const expectedArch = process.arch === 'x64' ? 'x86_64' :
  ...
  describe('Windows/WSL Behavior', () => {
    test('should detect Windows/WSL environment', () => {
      ...
      const mockUname = createTestFixture('mock-uname-windows', `#!/bin/bash
if [ "$1" = "-s" ]; then
