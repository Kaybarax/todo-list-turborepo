...
describe('Version Comparison Logic', () => {
  ...
  describe('Semantic Version Parsing', () => {
    ...
    test('should handle complex version strings', () => {
      const mockSolana = createTestFixture('mock-solana-complex', `#!/bin/bash
if [ "$1" = "--version" ]; then
...
exit 0`);
  ...
  describe('Invalid Version Handling', () => {
    test('should handle malformed version strings', () => {
      const mockInvalidVersion = createTestFixture('mock-invalid-version', `#!/bin/bash
if [ "$1" = "--version" ]; then
...
exit 0`);
    ...
    test('should handle empty version output', () => {
      const mockEmptyVersion = createTestFixture('mock-empty-version', `#!/bin/bash
if [ "$1" = "--version" ]; then
  echo ""
  exit 0
fi
...
exit 0`);
    ...
    test('should handle version command failures', () => {
      const mockFailingVersion = createTestFixture('mock-failing-version', `#!/bin/bash
if [ "$1" = "--version" ]; then
  exit 1
fi
echo "Mock command"
exit 0`);
  ...
  describe('Anchor Version Parsing', () => {
    test('should extract version from anchor --version output', () => {
      const mockAnchor = createTestFixture('mock-anchor-version', `#!/bin/bash
if [ "$1" = "--version" ]; then
...
exit 0`);
    ...
    test('should handle complex anchor version output', () => {
      const mockAnchorComplex = createTestFixture('mock-anchor-complex', `#!/bin/bash
if [ "$1" = "--version" ]; then
  echo "anchor-cli 0.29.0
...
exit 0`);
  ...
  describe('Rust Version Parsing', () => {
    test('should extract version from rustc --version output', () => {
      const mockRustc = createTestFixture('mock-rustc-version', `#!/bin/bash
if [ "$1" = "--version" ]; then
...
exit 0`);
    ...
    test('should handle nightly rust versions', () => {
      const mockRustcNightly = createTestFixture('mock-rustc-nightly', `#!/bin/bash
if [ "$1" = "--version" ]; then
