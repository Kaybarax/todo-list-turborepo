...
var DatabaseModule = exports.DatabaseModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forRootAsync({
                    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                        var databaseConfig, uri;
                        return __generator(this, function (_a) {
                            databaseConfig = configService.get('database');
                            uri = configService.get('MONGODB_URI') || 'mongodb://localhost:27017/todos';
                            return [2 /*return*/, __assign({ uri: uri }, databaseConfig === null || databaseConfig === void 0 ? void 0 : databaseConfig.options)];
                        });
                    }); },
