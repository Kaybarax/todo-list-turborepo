...
var HealthService = exports.HealthService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var HealthService = _classThis = /** @class */ (function () {
        function HealthService_1(connection, redisClient) {
            this.connection = connection;
            this.redisClient = redisClient;
        }
        HealthService_1.prototype.getHealth = function () {
            return __awaiter(this, void 0, void 0, function () {
                var dbStatus, redisStatus, error_1;
        ...
        HealthService_1.prototype.getReadiness = function () {
            return __awaiter(this, void 0, void 0, function () {
                var isDbReady, isRedisReady, error_2, isReady;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            isDbReady = this.connection.readyState === 1;
                            isRedisReady = false;
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 4];
                        case 4:
                            isReady = isDbReady && isRedisReady;
                            return [2 /*return*/, {
