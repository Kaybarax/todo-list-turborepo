...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("todo-node"),
    impl_name: create_runtime_str!("todo-node"),
    authoring_version: 1,
...
impl pallet_todo::Config for Runtime {
    ...
    type MaxTodosPerAccount = ConstU32<50>;
}
...
construct_runtime!(
    pub struct Runtime {
        ...
        Sudo: pallet_sudo,
        // Include the custom Todo pallet
        Todo: pallet_todo,
    }
);
